...
function FormsLogin() {
    ...
    return(
        ...
        <a className="btn w-100 m-3" style={ { background: '#f1d7d8ff', 'border-radius': '15px' } } onClick={ handleSubmit }>Entrar</a>

        <hr/>

        <p>Ainda não tem cadastro? <a className="m-3" href={ (formType === 'guardian') ? "/guardian" : "/parents" }>Cadastre-ser</a></p>
        </form>
        </section>
    );
}
